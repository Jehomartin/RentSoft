    ...
    <div class="row">
     <!--  <a class="navbar-brand text-uppercase text-expanded font-weight-bold d-lg-none" href="#">Start Bootstrap</a>
      ...
      <div class="two columns">
         <li>
            <a href="{{url('bienvenida') }}"><font color="#009797" size="4" face="arial black">Inicio</font></a>
         </li>
      </div>
      <div class="two columns">
         <li>
            <a href="{{url('rentas') }}"><font color="#009797" size="4" face="arial black">Rentas</font></a>
         </li>
      </div>
      <div class="two columns">
         <li>
            <a href="{{url('devolucion') }}"><font color="#009797" size="4" face="arial black">Devoluciones</font></a>
         </li>
      </div>
      <div class="two columns">
        <li>
            <a href="{{url('empleados') }}"><font color="#009797" size="4" face="arial black">Empleados</font>
            </a>
        </li>
      </div>
      <div class="two columns">
        <li>
          <a href="{{url('articulos') }}"><font color="#009797" size="4" face="arial black"> Articulos</font></a>
        </li>
      </div>
      <div class="two columns">
        <li>
          <a href="{{url('clientes') }}"><font color="#009797" size="4" face="arial black"> Clientes</font></a>
        </li>
      </div>
    </div>
  </div>
